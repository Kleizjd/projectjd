                ...
                <div class="card text-black" style="border-radius: 25px;">
                    <div class="card-body">
                        <div class="row justify-content-center">
                            ...
                            <div class="col-md-10 col-lg-6 col-xl-7 align-items-center order-2 order-lg-1">
                                {{-- <img src="images/team.png" class="img-fluid rounded-3" alt="Sample image"> --}}
                    <img src="images/background-new1.png" class="img-fluid rounded-3" alt="Sample image">
